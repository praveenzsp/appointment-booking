...
export const BookingSidebar = ({ isOpen, onClose, selectedDate, selectedTimezone, selectedTime, onSubmit }: BookingSidebarProps) => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-full w-full md:w-[600px] bg-white shadow-lg transform transition-transform duration-300 ease-in-out ${
    ...
    >
      <div className="p-6 h-full flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
          ...
          <button
            type="submit"
            className="mt-0 w-full bg-[#ff4081] text-white py-3 rounded-md hover:bg-[#e63a73] transition-colors"
          >
